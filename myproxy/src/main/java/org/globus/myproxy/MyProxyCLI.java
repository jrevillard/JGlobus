...
public class MyProxyCLI {
    ...
    private ArrayList<String> readVOMS_USERCONF() {
        String voms_userconf = System.getProperty("VOMS_USERCONF");
        if (voms_userconf == null) {
            return null;
        }

        ArrayList<String> vomses = new ArrayList<String>();
    ...
    protected void doGet(String args[], int start, boolean anonymous) {
        ...
        ArrayList<String> voname = new ArrayList<String>();
    ...
    protected void doPutOrStore(String args[], int start, boolean storeKey) {
        ...
        if (storeKey) {
            ...
            try {
                ...
                exit("Error: Failed to load key: " + userKeyFile, e);
            ...
            try {
                ...
                exit("Error: Failed to load certificate: " + userCertFile, e);
            } catch (GeneralSecurityException e) {
            	exit("Error: Failed to load certificate: " + userCertFile, e);
			}
